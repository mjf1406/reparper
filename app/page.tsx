        ...
        <div className="flex flex-col gap-10 items-center w-full mx-auto max-w-xl">
            ...
            <div className="space-y-5 pl-5 self-start w-full">
                ...
                <div className="px-4 py-3 bg-secondary rounded-xl">
                    ...
                    <Link
                        className="link"
                        href="https://docs.google.com/spreadsheets/d/1-L8p7gYqlG1pZO0LYcIHt6LWUPEj4TN9f59YmtQvgZI/copy"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <span>
                    ...
                    filled out with synthetic data generated by ChatGPT o1-mini.
                </div>
            </div>
